...
@Primary
@Repository
public class EncheresDAOImpl2 implements EncheresDAO {
	...
	private static final String DELETE_ENCHERE = "DELETE FROM ENCHERES WHERE no_utilisateur = :noUtilisateur";
	...
	public EncheresDAOImpl2(DataSource dataSource) {
